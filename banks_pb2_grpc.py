...
def add_BankServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Deposit': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=protos_dot_banks__pb2.DepositResponse.SerializeToString,
            ),
            'Withdraw': grpc.unary_unary_rpc_method_handler(
                    servicer.Withdraw,
                    request_deserializer=protos_dot_banks__pb2.WithdrawRequest.FromString,
                    response_serializer=protos_dot_banks__pb2.WithdrawResponse.SerializeToString,
            ),
